...
public:
  Adafruit_ADS1X15(TwoWire &w, uint8_t i2c_addr = ADS1X15_ADDRESS);
  bool begin();
...
public:
  Adafruit_ADS1015(TwoWire &, uint8_t i2cAddr = ADS1X15_ADDRESS);
};
...
public:
  Adafruit_ADS1115(TwoWire &, uint8_t i2cAddr = ADS1X15_ADDRESS);
};
