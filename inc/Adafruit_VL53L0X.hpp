...
#include <cox.h>
#include <TwoWire.hpp>
#include "Adafruit_VL53L0X/vl53l0x_api.h"
...
public:
  Adafruit_VL53L0X(TwoWire &, uint8_t i2cAddr = VL53L0X_I2C_ADDR);
  ...
  boolean begin(VL53L0X_Sense_config_t vl_config = VL53L0X_SENSE_DEFAULT,
                boolean debug = false);
